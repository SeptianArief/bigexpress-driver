...
class SpecialOrderSection extends StatefulWidget {
  ...
  @override
  State<SpecialOrderSection> createState() => _SpecialOrderSectionState();
}

class _SpecialOrderSectionState extends State<SpecialOrderSection> {
  @override

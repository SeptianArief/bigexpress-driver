...
class ActiveOrderSection extends StatefulWidget {
  ...
  @override
  State<ActiveOrderSection> createState() => _ActiveOrderSectionState();
}

class _ActiveOrderSectionState extends State<ActiveOrderSection> {
  @override

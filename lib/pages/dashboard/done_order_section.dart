...
class DoneOrderSection extends StatefulWidget {
  final UtilCubit transactionCubit;

  final Function onRefresh;
  const DoneOrderSection(
      {Key? key, required this.onRefresh, required this.transactionCubit})
      : super(key: key);

  @override
  State<DoneOrderSection> createState() => _DoneOrderSectionState();
}

class _DoneOrderSectionState extends State<DoneOrderSection> {
  @override
